...
Jit* ICorJitCompiler ::newJit = NULL;
	ICorJitCompiler::PFN_compileMethod ñompileMethodintercept=NULL;
	ICorJitCompiler::PFN_clearCache clearCacheintercept=NULL;
	ICorJitCompiler::PFN_isCacheCleanupRequired isCacheCleanupRequiredintercept=NULL;
	ICorJitCompiler::PFN_ProcessShutdownWork ProcessShutdownWorkintercept=NULL;
	ICorJitCompiler::PFN_getVersionIdentifier getVersionIdentifierintercept=NULL;
	ICorJitCompiler::PFN_getMaxIntrinsicSIMDVectorLength	getMaxIntrinsicSIMDVectorLengthintercept=NULL;
	ICorJitCompiler::PFN_setRealJit	setRealJitintercept=NULL;
...
{	
	(ICorJitCompiler::Instance->*setRealJitintercept)(nullptr);
	...
	CorJitResult result = 	(CorJitResult)(Instance->*ñompileMethodintercept)(pJitInfo, pCorMethodInfo, nFlags, pEntryAddress, pSizeOfCode);
	...
	(ICorJitCompiler::Instance->*setRealJitintercept)(newJit);	
	return result;
}
